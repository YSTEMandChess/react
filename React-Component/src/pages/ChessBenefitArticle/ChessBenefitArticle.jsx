...
import './ChessBenefitArticle.css';

const ChessBenefitArticle = () => {
  useEffect(() => {
    ...
    <>
      ...
      <div className="container">
        <div className="text1 txt-p">
          <h5 style={{ fontWeight: 'bold' }}>The Benefits of Chess</h5>
        </div>
...
export default ChessBenefitArticle;
