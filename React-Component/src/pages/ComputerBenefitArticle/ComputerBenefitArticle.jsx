...
import './ComputerBenefitArticle.css';

const ComputerBenefitArticle = () => {
  useEffect(() => {
    ...
    <>
      ...
      <div className="container">
        <div className="text1 txt-p">
          <h5 style={{ fontWeight: 'bold' }}>The Benefits of Computer Science Tutoring</h5>
        </div>
        ...
        <div className="text3 txt-p">
          <p>
            Computer science is a quickly growing field as technology becomes more ingrained in everyday life. Studying computer science lets students go into specialized careers and fields within STEM, and it also provides useful skills for many other jobs. With more work going remote and more jobs being automated, students will need to have digital skills for both in and out of the workplace.
          </p>
        </div>
        <div className="text4 txt-p">
          <p>
            Computer science has become fundamental to our lives, from the smartphones in our pockets to the computer you are reading this on. Learning more about how programming works and how apps are created, among other topics in computer science, helps students understand the world around them and make more informed choices. Skills such as online research, data analysis, and web programming are also becoming increasingly important and valuable. Learning about computer science will prepare students for their future.
          </p>
        </div>
      </div>
...
export default ComputerBenefitArticle;
