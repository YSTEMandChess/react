...
import './AboutUs.scss';
import aboutUsImage from '../../../images/aboutUs/about-us.png'; // Replace with actual image path
import dividerIcon from '../../../images/aboutUs/divide_icon.png'; // Replace with actual icon path
import statusIcon1 from '../../../images/aboutUs/02.png'; // Replace with actual icon path
import statusIcon2 from '../../../images/aboutUs/09.png'; // Replace with actual icon path
import statusIcon3 from '../../../images/aboutUs/40.png'; // Replace with actual icon path
import studentsImage from '../../../images/aboutUs/student.png'; // Replace with actual image path
