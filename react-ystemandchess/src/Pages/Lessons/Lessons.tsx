...
const Lessons = () => {
  ...
  const [draggingPiece, setDraggingPiece] = useState<{position: string, piece: {color: string, type: string}} | null>(null); // Track which piece is being dragged
  ...
  const setupScenario = (piece: string, scenario: string) => {
