...
const MentorProfile = () => {
    ...
    const openTab = (evt: React.MouseEvent<HTMLButtonElement, MouseEvent>, tabName: string, className: string) => {
    ...
    const showSharedSlideShowPdfList = (catId: any, catName: React.SetStateAction<string>) => {
