...
const MentorProfile = () => {
  ...
  const [sharedPdfList, setSharedPdfList] = useState<PdfItem[]>([]);
  ...
  useEffect(() => {
    ...
    const fetchUserInfo = async () => {
      ...
      setTimeout(() => {
        ...
        const defaultOpenStudent =
          document.getElementById("defaultOpenStudent");
  ...
  const showSharedSlideShowPdfList = (
    catId: any,
    catName: React.SetStateAction<string>
  ) => {
    ...
    switch (catId) {
      ...
      case "3":
        list = [
          {
            id: "1",
            FileName: "One Personal Development Lesson 1",
            FilePath:
              "https://documentcloud.adobe.com/view-sdk-demo/PDFs/Bodea Brochure.pdf",
          },
          // Add more files as necessary
  ...
  const getPresignURL = (sid: any, meetingId: any) => {
    ...
    <div className="userProfileDiv">
      ...
      <div className="container">
        <div className="myDiv text-center mb-4">
          <img
            className="user-img"
            src="../../../assets/images/mentor-profile/user.PNG"
            alt="User"
          />
          <h2>
      ...
      <div className="container">
        <div className="row mentor-section">
          <div className="student-tab">
            <button
              className="tablinks tablinks1"
              onClick={(e) => openTab(e, "Studentname1", "mainTabcontent")}
              id="defaultOpenStudent"
            >
              Student Name 1
            </button>
            <button
              className="tablinks tablinks2"
              onClick={(e) => openTab(e, "Studentname2", "mainTabcontent")}
            >
              Student Name 2
            </button>
            <button
              className="tablinks tablinks3"
              onClick={(e) => openTab(e, "Studentname3", "mainTabcontent")}
            >
              Student Name 3
            </button>
          </div>
          ...
          <div id="Studentname1" className="mainTabcontent">
            <div className="row mb-3">
              <div className="col-7">
                <div className="progressInfo">
                  <img
                    src="../../../assets/images/mentor-profile/student-graph.PNG"
                    alt="Student Graph"
                  />
                </div>
              </div>
              <div className="col-5">
                <div className="memberInfo">
                  ...
                  <p className="time-icon">
                    <span className="website-icon"></span>&nbsp; Lesson:{" "}
                    <strong>10 minutes</strong>
                  </p>
                  <p className="time-icon">
                    <span className="website-icon"></span>&nbsp; Puzzle:{" "}
                    <strong>5 minutes</strong>
                  </p>
                  <p className="time-icon">
                    <span className="website-icon"></span>&nbsp; Playing:{" "}
                    <strong>15 minutes</strong>
                  </p>
                  <p className="time-icon">
                    <span className="website-icon"></span>&nbsp; Mentoring:{" "}
                    <strong>15 minutes</strong>
                  </p>
                </div>
              </div>
            ...
            <div className="tab">
              <button
                ...
                onClick={(e) => openTab(e, "Activity", "tabcontent")}
                id="defaultOpen"
              >
                <img
                  src="../../../assets/images/student/activity_tab.png"
                  className="tab-image"
                  alt="Activity Tab"
                />
              </button>
              <button
                ...
                onClick={(e) => openTab(e, "Mentor_Session", "tabcontent")}
              >
                <img
                  src="../../../assets/images/student/mento_tab.PNG"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) =>
                  openTab(e, "Professional_Development", "tabcontent")
                }
              >
                <img
                  src="../../../assets/images/student/prodev_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "Chess_Lession", "tabcontent")}
              >
                <img
                  src="../../../assets/images/student/chess_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "Games", "tabcontent")}
              >
                <img
                  src="../../../assets/images/student/games_tab.PNG"
                  className="tab-image2"
                  alt="Games Tab"
                />
              </button>
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "Puzzles", "tabcontent")}
              >
                <img
                  src="../../../assets/images/student/puzzles_tab.PNG"
                  className="tab-image2"
                  alt="Puzzles Tab"
                />
              </button>
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "computer", "tabcontent")}
              >
                <img
                  src="../../../assets/images/student/play_tab.PNG"
                  className="tab-image2"
                  alt="Computer Tab"
                />
              </button>
              <button
                ...
                onClick={(e) => openTab(e, "Recordings", "tabcontent")}
              >
                <img
                  src="../../../assets/images/student/recordings_tab.PNG"
            ...
            <div id="Recordings" className="tabcontent">
              ...
              {recordingList.map((record: Record, index) => (
                <p key={index}>
                  <img
                    src="https://cdn.iconscout.com/icon/free/png-256/play-circle-round-player-music-30547.png"
                    srcSet="https://cdn.iconscout.com/icon/free/png-512/play-circle-round-player-music-30547.png 2x"
                    alt="Play Icon"
                    width="20"
                  />
                  &nbsp;
                  <strong>
                    <a
                      ...
                      title="Click to see the recording"
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={() =>
                        getPresignURL(record.sid, record.meetingId)
                      }
                    >
          ...
          <div id="Studentname2" className="mainTabcontent">
            ...
            <div className="tab">
              <button
                className="stablinks tab1"
                onClick={(e) => openTab(e, "Activity2", "tabcontent1")}
                id="defaultOpen2"
              >
                <img
                  src="../../../assets/images/student/activity_tab.png"
              ...
              <button
                className="stablinks tab2"
                onClick={(e) => openTab(e, "Mentor_Session2", "tabcontent1")}
              >
                <img
                  src="../../../assets/images/student/mento_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="stablinks tab2"
                onClick={(e) =>
                  openTab(e, "Professional_Development2", "tabcontent1")
                }
              >
                <img
                  src="../../../assets/images/student/prodev_tab.PNG"
              ...
              <button
                className="stablinks tab2"
                onClick={(e) => openTab(e, "Chess_Lession2", "tabcontent1")}
              >
                <img
                  src="../../../assets/images/student/chess_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="stablinks tab2"
                onClick={(e) => openTab(e, "Games2", "tabcontent1")}
              >
                <img
                  src="../../../assets/images/student/games_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="stablinks tab2"
                onClick={(e) => openTab(e, "Puzzles2", "tabcontent1")}
              >
                <img
                  src="../../../assets/images/student/puzzles_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="stablinks tab2"
                onClick={(e) => openTab(e, "computer2", "tabcontent1")}
              >
                <img
                  src="../../../assets/images/student/play_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="stablinks tab3"
                onClick={(e) => openTab(e, "Recordings2", "tabcontent1")}
              >
                <img
                  src="../../../assets/images/student/recordings_tab.PNG"
                  className="tab-image3"
          ...
          <div id="Studentname3" className="mainTabcontent">
            ...
            <div className="tab">
              <button
                className="tablinks tab1"
                onClick={(e) => openTab(e, "Activity3", "tabcontent2")}
                id="student3"
              >
                <img
                  src="../../../assets/images/student/activity_tab.png"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "Mentor_Session3", "tabcontent2")}
              >
                <img
                  src="../../../assets/images/student/mento_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) =>
                  openTab(e, "Professional_Development3", "tabcontent2")
                }
              >
                <img
                  src="../../../assets/images/student/prodev_tab.PNG"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "Chess_Lession3", "tabcontent2")}
              >
                <img
                  src="../../../assets/images/student/chess_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "Games3", "tabcontent2")}
              >
                <img
                  src="../../../assets/images/student/games_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "Puzzles3", "tabcontent2")}
              >
                <img
                  src="../../../assets/images/student/puzzles_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="tablinks tab2"
                onClick={(e) => openTab(e, "computer3", "tabcontent2")}
              >
                <img
                  src="../../../assets/images/student/play_tab.PNG"
                  className="tab-image2"
              ...
              <button
                className="tablinks tab3"
                onClick={(e) => openTab(e, "Recordings3", "tabcontent2")}
              >
                <img
                  src="../../../assets/images/student/recordings_tab.PNG"
                  className="tab-image3"
