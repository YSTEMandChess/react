...
import {
  ...
  getKingMoves,
  getQueenMoves,
} from "../Lessons/helpers/moveHelpers";
import { createChessBoard } from "../Lessons/createChessBoard";
...
const StudentInventory = ({ userPortraitSrc, userName }: any) => {
  ...
  const checkBlackPieces = () => {
    const blackPieces = board
      .flat()
      .filter((piece: string[]) => piece && piece[0] === "b"); // Filter out black pieces
      ...
      case "pawn":
        ...
        switch (scenario) {
          case "basic":
            ...
            setScenarioDescription_2(
              "Pawns move one square only. But when they reach the other side of the board, they become a stronger piece!"
            );
          ...
          case "training_3":
            ...
            setScenarioDescription_2(
              "No need to promote. Capture all black pawns."
            );
            setTrainingStarted(true); // Mark training as started
            break;
          case "special_move":
            ...
            updatedBoard[2][3] = "bP"; // d6
            setScenarioDescription_2(
              "A pawn on the second rank can move two squares forward."
            );
            setTrainingStarted(true); // Mark training as started
            break;
          default:
      ...
      case "rook":
        ...
        switch (scenario) {
          case "basic":
            ...
            updatedBoard[2][4] = "bP"; // e6
            setScenarioDescription_2(
              "Click on the rook to bring it to the pawn!"
            );
      ...
      case "bishop":
        ...
        switch (scenario) {
          ...
          case "training_3":
            ...
            updatedBoard[3][4] = "bP"; // e5
            setScenarioDescription_2(
              "One light-squared bishop, one dark-squared bishop. You need both!"
            );
            setTrainingStarted(true);
            break;
          case "training_4":
      ...
      case "knight":
        ...
        switch (scenario) {
          case "basic":
            ...
            updatedBoard[1][3] = "bP"; // d7
            setScenarioDescription_2(
              "Knights have a fancy way of jumping around!"
            );
            setTrainingStarted(true);
            break;
          ...
          case "training_3":
            ...
            updatedBoard[4][6] = "bP"; // g4
            setScenarioDescription_2(
              "Knights can jump over obstacles! Escape and vanquish the pawns!"
            );
            setTrainingStarted(true);
            break;
  ...
  const handleDrop = (key: any) => {
    if (highlightedSquares.includes(key)) {
      const [startRow, startCol] = draggingPiece.position
        .split("-")
        .map(Number);
