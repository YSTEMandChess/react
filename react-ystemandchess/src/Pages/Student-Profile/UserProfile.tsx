...
const UserProfile = () => {
  ...
  const openTab = (evt: React.MouseEvent<HTMLButtonElement, MouseEvent>, tabName: string) => {
  ...
  const showSharedSlideShowPdfList = (catId: string, catName: React.SetStateAction<string>) => {
