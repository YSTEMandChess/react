...
const UserProfile = () => {
  ...
  useEffect(() => {
    async function fetchUserInfo() {
      ...
      if (
        !uInfo.error &&
        (uInfo.role === "mentor" || uInfo.role === "student")
      ) {
        fetchRecordings();
      }
    }
    ...
    switch (catId) {
      ...
      case "3":
        pdfList = [
          ...
          {
            id: "2",
            FileName: "One Personal Development Lesson 2",
            FilePath:
              "https://documentcloud.adobe.com/view-sdk-demo/PDFs/Bodea Brochure.pdf",
          },
          {
            id: "3",
            FileName: "One Personal Development Lesson 3",
            FilePath:
              "https://documentcloud.adobe.com/view-sdk-demo/PDFs/Bodea Brochure.pdf",
          },
          {
            id: "4",
            FileName: "One Personal Development Lesson 4",
            FilePath:
              "https://documentcloud.adobe.com/view-sdk-demo/PDFs/Bodea Brochure.pdf",
          },
        ];
      ...
      case "4":
        pdfList = [
          ...
          {
            id: "2",
            FileName: "Chess Lesson 2",
            FilePath:
              "https://documentcloud.adobe.com/view-sdk-demo/PDFs/Bodea Brochure.pdf",
          },
          {
            id: "3",
            FileName: "Chess Lesson 3",
            FilePath:
              "https://documentcloud.adobe.com/view-sdk-demo/PDFs/Bodea Brochure.pdf",
          },
        ];
  ...
  // const showSharedSlideShow = (filePath: string) => {
  //   if (!window.AdobeDC) {
  ...
  const getPresignURL = async (sid: string, meetingId: string) => {
      ...
      <div className="container">
        ...
        <div className="col-12">
          ...
          <div className="row" style={{ marginBottom: "20px" }}>
            ...
            <div className="col-4">
              <p style={{ marginLeft: "20px" }}>
                <span className="lesson"></span>&nbsp; Lesson:{" "}
                <strong>10 minutes</strong>
              </p>
            </div>
            <div className="col-4">
              <p style={{ marginLeft: "20px" }}>
                <span className="puzzle"></span> &nbsp; Puzzle:{" "}
                <strong>5 minutes</strong>
              </p>
            </div>
            <div className="col-4">
              <p style={{ marginLeft: "20px" }}>
                <span className="playing"></span>&nbsp; Playing:{" "}
                <strong>15 minutes</strong>
              </p>
            </div>
            <div className="col-4">
              <p style={{ marginLeft: "20px" }}>
                <span className="mentoring"></span>&nbsp; Mentoring:{" "}
                <strong>15 minutes</strong>
              </p>
            </div>
          </div>
        ...
        <div className="tab">
          ...
          <button
            ...
            onClick={(e) => openTab(e, "Mentor_Session")}
          >
            <img
          ...
          <button
            className="tablinks tab2"
            onClick={(e) => openTab(e, "Professional_Development")}
          >
            <img
          ...
          <button
            className="tablinks tab2"
            onClick={(e) => openTab(e, "Chess_Lession")}
          >
            <img
          ...
          <button
            ...
            onClick={(e) => openTab(e, "Recordings")}
          >
            <img
            ...
            <p key={index}>
              ...
              <strong>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => getPresignURL(record.sid, record.meetingId)}
                >
