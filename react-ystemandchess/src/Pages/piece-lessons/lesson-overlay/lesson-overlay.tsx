  ...
  return (
    <div id="lesson-container">
      <div className="left-right-container">
        <div
          className="switchLesson"
          onClick={() => navigate("/lessons-selection")}
        >
          Switch Lesson
        </div>
      </div>
      ...
      <div className="right-container">
        ...
        <div className="prev-next-button-container">
          {lessonNum <= 0 ? (
            ...
            <button
              className="prevNextLessonButton prev"
      ...
      {showVPopup && (
        <div className="popup">
          <div className="popup-content">
            ...
            <button className="popup-button" onClick={handleVPopup}>
              OK
            </button>
          </div>
        </div>
      ...
      {showXPopup && (
        <div className="popup">
          <div className="popup-content">
            ...
            <button className="popup-button" onClick={handleXPopup}>
              OK
            </button>
          </div>
        </div>
      ...
      {showInstruction && (
        <div className="popup">
          <div className="popup-content">
            ...
            <button className="popup-button" onClick={handleShowInstruction}>
              Finished reading!
            </button>
          </div>
        </div>
