...
const AuthLayout = ({ panelTitle, step, children }: AuthLayoutProps) => {
  return (
    <div className="min-h-[71vh] flex items-center gap-8 px-4 lg:px-60 py-12">
      <aside className="hidden lg:flex flex-col justify-center gap-10 w-64 shrink-0">
        {benefits.map((b) => (
      ...
      <aside className="hidden lg:flex flex-col items-center justify-center gap-6 w-72 shrink-0">
