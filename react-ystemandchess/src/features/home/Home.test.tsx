...
it("renders join & subscribe", () => {
    ...
    expect(screen.getByText(/Everyone is included. Everyone is welcome./i)).toBeInTheDocument();
...
it("renders both book titles", () => {
    ...
    expect(screen.getByText(/How to Start a Tech-Based Nonprofit/i)).toBeInTheDocument();
